...
# This is the Version 1.0 of my challenge it includes the code for the first sheet the 2019.
...
Sub stockmkt()
    ...
    Worksheets("2019").Cells(1, 9) = "Ticker Symbol"
    Worksheets("2019").Cells(1, 10) = "Yearly change"
    Worksheets("2019").Cells(1, 11) = "Percent change"
    Worksheets("2019").Cells(1, 12) = "Total Stock Volume"
    Worksheets("2019").Cells(1, 13) = "Close price"
    Worksheets("2019").Cells(1, 14) = "Open price"
...
Next i
    ...
    Worksheets("2019").Cells(2, 16) = "Greatest % Increase"
    Worksheets("2019").Cells(3, 16) = "Greatest % Decrease"
    Worksheets("2019").Cells(4, 16) = "Greatest Total Volume"
    Worksheets("2019").Cells(1, 17) = "Ticker"
    Worksheets("2019").Cells(1, 18) = "Value"
